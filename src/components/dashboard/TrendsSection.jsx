  ...
  if (active && payload?.length) {
    return (
      <div className="glass-strong rounded-xl px-3 py-2">
        ...
        <p className="text-xs text-purple-500">{payload[0].value} check-ins</p>
      </div>
    );
  }
  return null;
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <GlassCard className="p-4 text-center" animate={false}>
          <p className="font-heading text-2xl font-bold text-purple-500">{consistencyScore}%</p>
        ...
        <GlassCard className="p-4 text-center" animate={false}>
          <p className="font-heading text-2xl font-bold text-teal-500">{DAY_LABELS[topDayIdx]}</p>
          ...
          <BarChart data={dailyCounts} barSize={10} margin={{ top: 0, right: 0, left: -30, bottom: 0 }}>
            ...
            <defs>
              <linearGradient id="barGrad" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="100%" stopColor="#60d3c4" />
              </linearGradient>
